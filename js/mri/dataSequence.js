...
export const sequenceData = [
    ...
    { 
        ...
        type: "Sequence", 
        description: "Đo lưu lượng (ml/s) hoặc vận tốc (cm/s) đi qua van tim hoặc cống脑.", 
    ...
    { 
        ...
        vi: "Xóa dịch T1", 
        type: "Sequence", 
        description: "Sử dụng TI ngắn (~800ms) để xóa tín hiệu dịch脑tủy trên ảnh T1W, thay vì T2W.", 
