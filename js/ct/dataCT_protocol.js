// CƠ SỞ DỮ LIỆU CT - PHẦN QUY TRÌNH CHỤP (PROTOCOL THƯỜNG)
export const ctProtocolData = [
    ...
    },
    {
        ...
        vi: "[🧠 THẦN KINH] Bộ ba CT Đột quỵ (NCCT + Perfusion + CTA)",
        type: "Protocol",
        ...
        advancedSequences: "Dựng hình MIP mỏng (10-15mm) đa mặt phẳng để theo dõi nhánh mạch máu tắc. Sử dụng phần mềm AI (VD: RAPID, syngo.via) để tự động tính thể tích Penumbra mang màu sắc.",
