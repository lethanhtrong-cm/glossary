...
export async function loadPendingApprovals() {
    ...
    try {
        ...
        // Gắn sự kiện chuẩn ES6 cho các nút vừa tạo
        ...
        pendingTableBody.innerHTML = `<tr><td colspan="7" style="text-align: center; color: red;">Lỗi tải dữ liệu từ Firestore. Vui lòng kiểm tra quyền truy cập (Rules).</td></tr>`;
    }
}
